...
var UIController = (function(){
    ...
    var DOMstrings = {
        ...
        // expensesPercLabel: document.querySelectorAll('.item__percentage'),
    ...
    return {
        ...
        displayBudget: function(obj){
            ...
            if(obj.percentage > 0)
                DOMstrings.percentage.textContent = obj.percentage + '%';
            else
                DOMstrings.percentage.textContent = '---';
        },
